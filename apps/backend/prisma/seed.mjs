...
export async function seedDatabase(prisma) {
  ...
  await prisma.ward.createMany({
    data: [
      ...
      {
        id: ids.wards.centralConsultorio,
        facilityId: ids.facilities.residenciaCentral,
        code: 'consultorio',
        name: 'Consultorio',
        createdAt: new Date('2026-01-10T09:00:00.000Z'),
  ...
  // Los modelos ResidentObservation/ResidentObservationEntry fueron reemplazados
  // por ResidentObservationNote (migración 20260416100000). El seed histórico
  // de esos modelos se removió porque ya no existen en el schema.
