        ...
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div className="grid gap-2.5">
            ...
            <p className="max-w-[60ch] leading-[1.65] text-brand-text-secondary">
              Selecciona un miembro del equipo, revisa sus guardias semanales y
              agrega coberturas puntuales desde un solo workspace.
            </p>
          </div>

          <div className="flex flex-wrap items-center gap-3">
            <span className={primaryButtonClassName}>{staff.length} perfiles</span>
            <span className={primaryButtonClassName}>{schedules.length} horarios</span>
          </div>
        </div>
      </section>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        <strong className="text-brand-text">{member.name}</strong>
                        <span
                      ...
                      >
                        ...
                        {schedule.exceptionDate && (
                          <p className="mt-3 text-brand-text-secondary">
                            Fecha puntual: {toDateInputValue(schedule.exceptionDate)}
                          </p>
                        )}
